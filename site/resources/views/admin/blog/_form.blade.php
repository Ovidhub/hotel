...
<div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
    ...
    <div class="lg:col-span-2">
        ...
        <input type="text" name="title" value="{{ old('title', $post->title ?? '') }}"
               class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#7C0E52] focus:outline-none focus:ring-1 focus:ring-[#7C0E52] @error('title') border-red-400 @enderror">
    ...
    <div>
        ...
        <input type="text" name="author" value="{{ old('author', $post->author ?? '') }}"
               class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#7C0E52] focus:outline-none focus:ring-1 focus:ring-[#7C0E52] @error('author') border-red-400 @enderror">
...
<div class="mt-5">
    ...
    <input type="text" name="image" value="{{ old('image', $post->image ?? '') }}"
           class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#7C0E52] focus:outline-none focus:ring-1 focus:ring-[#7C0E52] @error('image') border-red-400 @enderror">
...
<div class="mt-5">
    ...
    <textarea name="excerpt" rows="2"
              class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#7C0E52] focus:outline-none focus:ring-1 focus:ring-[#7C0E52] @error('excerpt') border-red-400 @enderror">{{ old('excerpt', $post->excerpt ?? '') }}</textarea>
...
<div class="mt-5">
    ...
    <textarea name="body" rows="10"
              class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm font-mono focus:border-[#7C0E52] focus:outline-none focus:ring-1 focus:ring-[#7C0E52] @error('body') border-red-400 @enderror">{{ old('body', $post->body ?? '') }}</textarea>
