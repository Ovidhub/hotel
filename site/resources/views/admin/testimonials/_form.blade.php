...
<div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
    ...
    <div>
        ...
        <input type="text" name="role" value="{{ old('role', $testimonial->role ?? '') }}"
               ...
               class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#1D5C52] focus:outline-none focus:ring-1 focus:ring-[#1D5C52] @error('role') border-red-400 @enderror">
    ...
    <div>
        ...
        <select name="rating"
                class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#1D5C52] focus:outline-none focus:ring-1 focus:ring-[#1D5C52] @error('rating') border-red-400 @enderror">
            @for($i = 1; $i <= 5; $i++)
...
<div class="mt-5">
    ...
    <textarea name="text" rows="4"
              class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#1D5C52] focus:outline-none focus:ring-1 focus:ring-[#1D5C52] @error('text') border-red-400 @enderror">{{ old('text', $testimonial->text ?? '') }}</textarea>
