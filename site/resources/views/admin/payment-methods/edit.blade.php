<x-layouts.admin title="Edit Payment Method">

    <div class="mb-5 flex items-center gap-2 text-sm text-gray-500">
        <a href="{{ route('admin.payment-methods.index') }}" class="hover:text-[#7C0E52] transition-colors">Payment Methods</a>
        <span>/</span>
        <span class="text-gray-800 font-medium">{{ $paymentMethod->name }}</span>
    </div>

    <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
        <h2 class="mb-6 text-base font-semibold text-gray-800">Edit Payment Method</h2>
