...
<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
    ...
    <div>
        ...
        <input type="text" name="provider" value="{{ old('provider', $paymentMethod->provider ?? '') }}"
               ...
               class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#7C0E52] focus:outline-none focus:ring-1 focus:ring-[#7C0E52] @error('provider') border-red-400 @enderror">
...
<div class="mt-5">
    ...
    <textarea name="instructions" rows="4"
              class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#7C0E52] focus:outline-none focus:ring-1 focus:ring-[#7C0E52] @error('instructions') border-red-400 @enderror">{{ old('instructions', $paymentMethod->instructions ?? '') }}</textarea>
