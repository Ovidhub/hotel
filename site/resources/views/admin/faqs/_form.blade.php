...
<div class="mb-5">
    ...
    <input type="text" name="question" value="{{ old('question', $faq->question ?? '') }}"
           class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#7C0E52] focus:outline-none focus:ring-1 focus:ring-[#7C0E52] @error('question') border-red-400 @enderror">
...
<div class="mb-5">
    ...
    <textarea name="answer" rows="4"
              class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#7C0E52] focus:outline-none focus:ring-1 focus:ring-[#7C0E52] @error('answer') border-red-400 @enderror">{{ old('answer', $faq->answer ?? '') }}</textarea>
